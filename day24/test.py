# From post: https://www.reddit.com/r/adventofcode/comments/18pnycy/comment/kesvc7t
...
print( f'pxr={pxr} vxr={vxr} pyr={pyr} vyr={vyr}')
...
print(f'vzr={vzr}')
pzr = pz0 + t0 * ( vz0 - vzr )
print(f't0={t0} vz0={vz0} vzr={vzr} t0 *(vz0 - vzr)={t0 *(vz0 - vzr)} pz0={pz0}  pzr={pzr}')
print(f'pzr={pzr}')

print( f'Part2 ={pxr + pyr + pzr}' )
